...
// 	documentEncoding encoding.Factory
...
// func (dpm *DatasetPartitionManager) GetPartition(ctx context.Context, key rdf.IRI, graphName rdf.GraphNameValue) (rdfio.Dataset, error) {
