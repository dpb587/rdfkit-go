...
// 2c09eed77869a80b37356c02905d6a2bda372de45cb8a1e14c4fe5f2fcd25d57  https://schema.org/version/latest/schemaorg-all-https.ttl

package schemairi

import "github.com/dpb587/rdfkit-go/rdf"

const Base rdf.IRI = "https://schema.org/"
...
const (
	...
	// applications designed to use specific schema.org properties (e.g. https://schema.org/width,
	// https://schema.org/color, https://schema.org/gtin13, ...) will typically expect such data to be provided using
	...
	// https://schema.org/Male and https://schema.org/Female may be used, text strings are also acceptable for people who
	...
	// [leiCode](https://schema.org/leiCode) (`0199`), [duns](https://schema.org/duns) (`0060`) or
	// [GLN](https://schema.org/globalLocationNumber) (`0088`) can be expressed using ISO-6523. If possible, ISO-6523
	// codes should be preferred to populating [vatID](https://schema.org/vatID) or [taxID](https://schema.org/taxID), as
	...
	// explicitly via URL, ```https://schema.org/docs/releases.html#v10.0```. There may be situations in which other
