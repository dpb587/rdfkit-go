...
| ✅&nbsp;PASS | NegativeSyntax | turtle-syntax-bad-kw-05 |
...
| ✅&nbsp;PASS | NegativeSyntax | turtle-syntax-bad-string-01 |
...
| ✅&nbsp;PASS | PositiveSyntax | turtle-syntax-bnode-04 |
...
| ✅&nbsp;PASS | PositiveSyntax | turtle-syntax-prefix-01 |
...
```
error: token (statement): offset L2C44;0x4e: unexpected rune ('.')
```
...
```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_QUOTE): token (ECHAR): offset L2C82;0x65: unexpected rune ('z')
```

### ✅ NegativeSyntax, turtle-syntax-bad-esc-02

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_QUOTE): token (UCHAR): offset L2C82;0x65: unexpected rune ('W')
```

### ✅ NegativeSyntax, turtle-syntax-bad-esc-03

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_QUOTE): token (UCHAR): offset L2C86;0x69: unexpected rune ('W')
```
...
```
error: token (predicateObjectList): token (verb): token (PrefixedName; offset=L2C4:L2C5;0x35:0x36): unknown prefix: A
```

### ✅ NegativeSyntax, turtle-syntax-bad-kw-02

```
error: token (triples): token (subject): token (PrefixedName; offset=L2C1:L2C2;0x32:0x33): unknown prefix: a
```

### ✅ NegativeSyntax, turtle-syntax-bad-kw-03

```
error: token (object): token (PrefixedName; offset=L2C7:L2C8;0x38:0x39): unknown prefix: a
```

### ✅ NegativeSyntax, turtle-syntax-bad-kw-04

```
error: token (triples): token (subject): token (PrefixedName; offset=L2C1:L2C5;0x32:0x36): unknown prefix: true
```

### ✅ NegativeSyntax, turtle-syntax-bad-kw-05

```
error: token (predicateObjectList): token (verb): token (PrefixedName; offset=L2C4:L2C8;0x35:0x39): unknown prefix: true
```

### ✅ NegativeSyntax, turtle-syntax-bad-lang-01

```
error: token (triples): offset L2C88;0x66: unexpected rune ('1')
```

### ✅ NegativeSyntax, turtle-syntax-bad-ln-dash-start

```
error: token (triples): offset L2C8;0x39: unexpected rune ('-')
```

### ✅ NegativeSyntax, turtle-syntax-bad-ln-escape

```
error: token (object): token (PrefixedName): token (PN_LOCAL): token (PERCENT): token (HEX): offset L2C11;0x3c: unexpected rune (' ')
```

### ✅ NegativeSyntax, turtle-syntax-bad-ln-escape-start

```
error: token (object): token (PrefixedName): token (PN_LOCAL): token (PERCENT): token (HEX): offset L2C10;0x3b: unexpected rune ('o')
```

### ✅ NegativeSyntax, turtle-syntax-bad-missing-ns-dot-end

```
error: token (triples): token (subject): token (PrefixedName; offset=L1C1:L1C8;0x0:0x7): unknown prefix: valid
```

### ✅ NegativeSyntax, turtle-syntax-bad-missing-ns-dot-start

```
error: token (statement): offset L1C1;0x0: unexpected rune ('.')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-01

```
error: token (statement): offset L4C1;0x4e: unexpected rune ('{')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-02

```
error: token (triples): offset L4C4;0x48: unexpected rune ('=')
```
...
```
error: token (triples): offset L5C3;0x76: unexpected rune ('^')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-05

```
error: token (predicateObjectList): token (verb): token (PrefixedName; offset=L4C4:L4C6;0x43:0x45): unknown prefix: is
```
...
### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-07
...
```
error: token (triples): offset L3C4;0x48: unexpected rune ('=')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-10

```
error: token (predicateObjectList): token (verb): token (IRIREF): offset L3C6;0x4a: unexpected rune (' ')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-11

```
error: token (directive): offset L3C2;0x4c: unexpected rune ('f')
```

### ✅ NegativeSyntax, turtle-syntax-bad-n3-extras-12

```
error: token (directive): offset L3C2;0x4b: unexpected rune ('f')
```
...
```
error: token (directive): token (prefixID): token (PNAME_NS): offset L1C11;0xa: unexpected rune ('.')
```
...
```
error: token (triples): token (subject): token (PrefixedName; offset=L1C83:L1C86;0x52:0x55): unknown prefix: abc
```

### ✅ NegativeSyntax, turtle-syntax-bad-num-02

```
error: token (object): token (literal): token (NumericLiteral): token (DOUBLE): token (EXPONENT): offset L1C83;0x52: unexpected rune (' ')
```

### ✅ NegativeSyntax, turtle-syntax-bad-num-03

```
error: token (triples): offset L1C82;0x51: unexpected rune ('a')
```

### ✅ NegativeSyntax, turtle-syntax-bad-num-04

```
error: token (triples): offset L1C80;0x4f: unexpected rune ('x')
```

### ✅ NegativeSyntax, turtle-syntax-bad-num-05

```
error: token (object): token (literal): token (NumericLiteral): token (NumericLiteral): offset L1C79;0x4e: unexpected rune ('+')
```

### ✅ NegativeSyntax, turtle-syntax-bad-num-05

```
error: token (triples): offset L1C67;0x42: unexpected rune ('^')
```

### ✅ NegativeSyntax, turtle-syntax-bad-number-dot-in-anon

```
error: token (blankNodePropertyList): offset L5C9;0x44: unexpected rune ('.')
```

### ✅ NegativeSyntax, turtle-syntax-bad-pname-01

```
error: token (triples): offset L3C3;0x49: unexpected rune ('~')
```

### ✅ NegativeSyntax, turtle-syntax-bad-pname-02

```
error: token (triples): token (subject): token (PrefixedName): token (PN_LOCAL): token (PERCENT): token (HEX): offset L3C5;0x47: unexpected rune (' ')
```

### ✅ NegativeSyntax, turtle-syntax-bad-pname-03

```
error: token (triples): token (subject): token (PrefixedName): token (PN_LOCAL): token (PN_LOCAL_ESC): offset L3C4;0x4a: unexpected rune ('u')
```

### ✅ NegativeSyntax, turtle-syntax-bad-prefix-01

```
error: token (triples): token (subject): token (PrefixedName; offset=L2C1:L2C3;0xc:0xe): unknown prefix: 
```

### ✅ NegativeSyntax, turtle-syntax-bad-prefix-02

```
error: token (object): token (PrefixedName; offset=L3C49:L3C51;0x7d:0x7f): unknown prefix: 
```
...
```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_QUOTE): offset L3C1;0x40: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-string-02

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_SINGLE_QUOTE): offset L3C1;0x40: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-string-03

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_LONG_SINGLE_QUOTE): offset L3C1;0x42: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-string-04

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_LONG_QUOTE): offset L3C1;0x44: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-string-05

```
error: token (object): token (literal): token (RDFLiteral): token (String): token (STRING_LITERAL_LONG_QUOTE): offset L5C1;0x63: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-string-06

```
error: token (triples): offset L3C16;0x58: unexpected rune ('"')
```
...
```
error: token (statement): offset L2C1;0x15: unexpected rune ('{')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-02

```
error: token (triples): offset L2C40;0x3a: unexpected rune ('=')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-03

```
error: token (triples): offset L2C118;0x8c: unexpected rune ('<')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-04

```
error: token (statement): offset L2C1;0x2d: unexpected rune ('"')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-05

```
error: token (triples): offset L2C40;0x56: unexpected rune ('"')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-06

```
error: token (triples): offset L2C40;0x54: unexpected rune ('[')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-07

```
error: token (triples): offset L2C40;0x54: unexpected rune ('_')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-08

```
error: token (objectList): offset L2C117;0x7d: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-09

```
error: token (statement): offset L2C120;0x86: unexpected rune ('.')
```
...
```
error: token (predicateObjectList): offset L2C119;0x83: EOF
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-12

```
error: token (object): offset L1C78;0x4d: EOF
```
...
```
error: token (triples): offset L2C40;0x3e: unexpected rune ('"')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-16

```
error: token (triples): offset L2C40;0x3c: unexpected rune ('[')
```

### ✅ NegativeSyntax, turtle-syntax-bad-struct-17

```
error: token (triples): offset L2C40;0x3c: unexpected rune ('_')
```

### ✅ NegativeSyntax, turtle-syntax-bad-uri-01

```
error: token (triples): token (subject): token (IRIREF): offset L2C37;0x37: unexpected rune (' ')
```

### ✅ NegativeSyntax, turtle-syntax-bad-uri-02

```
error: token (triples): token (subject): token (IRIREF): token (UCHAR): offset L2C41;0x3f: unexpected rune ('Z')
```
...
```
error: token (triples): token (subject): token (IRIREF): offset L2C38;0x50: unexpected rune ('n')
```

### ✅ NegativeSyntax, turtle-syntax-bad-uri-05

```
error: token (triples): token (subject): token (IRIREF): offset L2C38;0x50: unexpected rune ('/')
```
