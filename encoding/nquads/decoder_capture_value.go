...
func (r *Decoder) captureSubjectOrGraphValue(grammarRule grammar.R) (rdf.SubjectValue, *cursorio.TextOffsetRange, error) {
	for {
		r0, err := r.buf.NextRune()
		if err != nil {
			return nil, nil, grammarRule.Err(r.newOffsetError(err, cursorio.DecodedRunes{}, cursorio.DecodedRunes{}))
		}
		...
		case r0.Rune == '<':
			...
			if err != nil {
				return nil, nil, grammarRule.Err(err)
			}
		...
		case r0.Rune == '_':
			...
			if r1.Rune != ':' {
				return nil, nil, grammarRule.Err(r.newOffsetError(cursorioutil.UnexpectedRuneError{Rune: r1.Rune}, r0.AsDecodedRunes(), r1.AsDecodedRunes()))
			}
		...
		default:
			return nil, nil, grammarRule.Err(r.newOffsetError(cursorioutil.UnexpectedRuneError{Rune: r0.Rune}, cursorio.DecodedRunes{}, r0.AsDecodedRunes()))
		}
	}
}
