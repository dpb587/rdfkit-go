...
```
error: token (triple): token (subject): offset L1C1;0x0: unexpected rune ('@')
```

### ✅ NegativeSyntax, nt-syntax-bad-esc-01

```
error: token (triple): token (object): token (literal): token (STRING_LITERAL_QUOTE): offset L2C42;0x3d: unexpected rune ('z')
```

### ✅ NegativeSyntax, nt-syntax-bad-esc-02

```
error: token (triple): token (object): token (literal): token (STRING_LITERAL_QUOTE): token (UCHAR): offset L2C42;0x3d: unexpected rune ('W')
```

### ✅ NegativeSyntax, nt-syntax-bad-esc-03

```
error: token (triple): token (object): token (literal): token (STRING_LITERAL_QUOTE): token (UCHAR): offset L2C46;0x41: unexpected rune ('W')
```

### ✅ NegativeSyntax, nt-syntax-bad-lang-01

```
error: token (triple): offset L2C48;0x3e: unexpected rune ('1')
```

### ✅ NegativeSyntax, nt-syntax-bad-num-01

```
error: token (triple): token (object): offset L1C39;0x26: unexpected rune ('1')
```
...
```
error: token (triple): token (object): token (literal): token (STRING_LITERAL_QUOTE): offset L2C1;0x2e: EOF
```
...
```
error: token (triple): token (object): offset L1C39;0x26: unexpected rune ('\'')
```

### ✅ NegativeSyntax, nt-syntax-bad-string-05

```
error: token (triple): offset L1C41;0x28: unexpected rune ('"')
```

### ✅ NegativeSyntax, nt-syntax-bad-string-06

```
error: token (triple): token (object): token (literal): token (STRING_LITERAL_QUOTE): offset L2C1;0x2d: EOF
```

### ✅ NegativeSyntax, nt-syntax-bad-string-07

```
error: token (triple): token (object): offset L1C39;0x26: unexpected rune ('a')
```

### ✅ NegativeSyntax, nt-syntax-bad-struct-01

```
error: token (triple): offset L1C57;0x38: unexpected rune (',')
```
...
```
error: token (triple): token (subject): token (IRIREF): offset L2C17;0x23: unexpected rune (' ')
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-02

```
error: token (triple): token (subject): token (IRIREF): token (UCHAR): offset L2C21;0x2b: unexpected rune ('Z')
```
...
```
error: token (triple): token (subject): token (IRIREF): offset L2C18;0x3c: unexpected rune ('n')
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-05

```
error: token (triple): token (subject): token (IRIREF): offset L2C18;0x3c: unexpected rune ('/')
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-06

```
error: token (triple): token (subject): token (IRIREF; offset=L2C1:L2C4;0x20:0x23): relative urls are not allowed
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-07

```
error: token (triple): token (predicate): token (IRIREF; offset=L2C20:L2C23;0x33:0x36): relative urls are not allowed
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-08

```
error: token (triple): token (object): token (IRIREF; offset=L2C39:L2C42;0x46:0x49): relative urls are not allowed
```

### ✅ NegativeSyntax, nt-syntax-bad-uri-09

```
error: token (triple): token (object): token (literal): token (IRIREF; offset=L2C46:L2C50;0x4d:0x51): relative urls are not allowed
```
